    ...
    <div className="fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center">
      ...
      >
        <p className="font-light">
          Would you like to activate the stellar soundtrack for your cosmic
          journey?
        </p>
...
const Sound = () => {
  ...
  const toggle = () => {
    ...
    newState
      ? (audioRef.current.play(), (audioRef.current.volume = 0.025))
  ...
  return (
    <div className="fixed top-4 right-2.5 xs:right-4 z-50 group">
      ...
      <audio ref={audioRef} loop>
        <source src={"/audio/elevator-ride-296159.mp3"} type="audio/mpeg" />
